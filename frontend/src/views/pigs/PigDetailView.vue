  ...
  <div class="max-w-3xl mx-auto space-y-6">
    ...
    <template v-else-if="animal">
      ...
      <div v-if="isFemale" class="card space-y-4">
        ...
        <!-- Inseminaciones pendientes de confirmación -->
          ...
          >
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 gap-2 text-sm">
              ...
              <div v-if="r.semen_source">
                <p class="text-xs text-amber-600 font-medium uppercase tracking-wide">Verraco</p>
            ...
            <p class="text-xs text-amber-600">¿La cerda quedó preñada? Confirma o descarta esta inseminación.</p>
